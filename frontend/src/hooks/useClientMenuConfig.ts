...
export const DEFAULT_MENU_ITEMS: MenuItemConfig[] = [
  ...
  { key: 'contacts', label: 'Leads', visible: true, position: 3, type: 'item', icon: '◇' },
  { key: 'chats', label: 'Conversations', visible: true, position: 4, type: 'item', icon: '✉' },
  { key: 'section-config', label: 'CONFIG', visible: true, position: 5, locked: true, type: 'section-label' },
  { key: 'credentials', label: 'Credentials', visible: true, position: 6, type: 'item', icon: '⚷' },
  { key: 'text-setter', label: 'Text Setter', visible: true, position: 7, type: 'item', icon: '░' },
  { key: 'voice-setter', label: 'Voice Setter', visible: true, position: 8, type: 'item', icon: '♫' },
  { key: 'section-ops', label: 'OPS', visible: true, position: 9, locked: true, type: 'section-label' },
  { key: 'simulator', label: 'Simulator', visible: true, position: 10, type: 'item', icon: '⚔' },
  { key: 'workflows', label: 'Campaigns', visible: true, position: 11, type: 'item', icon: '⛓' },
  { key: 'logs', label: 'Logs', visible: true, position: 12, type: 'item', icon: '⚡' },
  { key: 'section-debug', label: 'BACKEND', visible: true, position: 13, locked: true, type: 'section-label' },
  { key: 'openrouter-usage', label: 'OpenRouter Usage', visible: true, position: 14, type: 'item', icon: '□' },
  { key: 'supabase-usage', label: 'Supabase Usage', visible: true, position: 15, type: 'item', icon: '⛁' },
  { key: 'templates', label: 'Source Files', visible: true, position: 16, type: 'item', icon: '⌐' },
  { key: 'demo-pages', label: 'Work Pages', visible: false, position: 17, type: 'item', icon: '⊞' },
];
