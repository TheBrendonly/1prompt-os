-- Phase 1: Database hardening (fixed version)
...
DROP TRIGGER IF EXISTS set_lead_fingerprint_trigger ON public.leads;
DROP TRIGGER IF EXISTS check_campaign_completion_trigger ON public.leads;
...
CREATE UNIQUE INDEX IF NOT EXISTS leads_campaign_fingerprint_unique_idx 
