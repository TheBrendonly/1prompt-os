-- Fix the lock_next_batch function to properly order leads by created_at
...
BEGIN
  ...
  -- First, get the IDs of leads to process in the correct order
  ...
  -- Then atomically lock and return those specific leads
  RETURN QUERY
  UPDATE leads 
